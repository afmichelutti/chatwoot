...
describe Contacts::ContactableInboxesService do
  ...
  describe '#get' do
    ...
    context 'when website inbox is available' do
      ...
      it 'does not return existing source id if contact inbox exists with a non-resolved conversation' do
        contact_inbox = create(:contact_inbox, inbox: website_inbox, contact: contact)
      ...
      it 'returns existing source id if contact inbox exists with only resolved conversations' do
        contact_inbox = create(:contact_inbox, inbox: website_inbox, contact: contact)
        create(:conversation, contact: contact, inbox: website_inbox, contact_inbox: contact_inbox, status: :resolved)
